...
BEGIN
  ...
  -- Insert role from metadata, default to 'officer'
  INSERT INTO public.user_roles (user_id, role)
  VALUES (NEW.id, COALESCE((NEW.raw_user_meta_data->>'role')::app_role, 'officer'));
...
-- Update claims RLS to require authentication
...
DROP POLICY IF EXISTS "Anyone can delete claims" ON public.claims;
